...
-- Tiempo de generación: 02-05-2022 a las 01:38:43
...
(1, 'Notifiacion de prueba', 'no_vista', 1),
(2, 'Notifiacion de prueba', 'no_vista', 1),
(3, 'Notifiacion de prueba', 'no_vista', 1),
(4, 'Notifiacion de prueba', 'no_vista', 1),
(5, 'Otra notificacion', 'no_vista', 2),
(6, 'Otra notificacion', 'no_vista', 2);
...
(7, 'Probando Novedad', 'Este es un subtitulo de prueba', 'Cuerpo de prueba de novedad (que estoy modificando)', 'cpx1ajspdsxuvx5csb54');
...
(1, 'SUPER OFERTAS', '     Del 01 al 31 de Abril hasta agotar stock ', 'principal'),
...
(1, 'Cargador celulares', 'Cargador carga rapida', 'ydceq5kqnolv5rizhefb', 1000, 'IGLU-FIVE', 'active', 'Carga rapida'),
(2, 'Pendrive', '64 GB 3.0', 'qovtkojmpoed5kksgq8m', 1500, 'VERBATIM', 'active', ''),
(3, 'Pendrive 16 gb', 'Pendrive 3.0', NULL, 1500, 'Kingston', 'active', ''),
(4, 'Pendrive 32 gb', 'Pendrive 3.0', NULL, 1800, 'Kingston', 'removed', 'Producto en promocion hasta agotar stdoc'),
(5, 'Pendrive 64 gb', 'Pendrive 3.0', NULL, 2500, 'Kingston', 'active', ''),
...
(65, 'real madrid', 'Decricion produycto Y', NULL, 100, 'Y MARCA', 'active', NULL),
(66, 'real madrid', 'Decricion produycto Y', NULL, 100, 'Y MARCA', 'active', NULL),
(67, 'real madrid', 'Decricion produycto Y', NULL, 100, 'Y MARCA', 'active', NULL),
...
(71, 'Guanchope \"offside\" Avila', 'banderin arriba', NULL, 404040, 'LEDESMA', 'active', NULL),
...
(1, 'Servicio Tecnico de Pc', 'Disco solido ipsum dolor sit amet consectetur adipisicing elit. Fuga tempora, quaerat, quam iusto veritatis animi eos repudiandae neque maiores quo quas doloremque eius, officiis placeat! Vero dolorum necessitatibus saepe laudantium!\r\n', 'w6tqpy7ywokbhznvhb5l'),
...
(3, 'Agrego sevicio por primera vez', 'Agergando servicio (modificado 20/04)', 'fhfgx5znfr8oexnjjrav'),
...
(1, 122, '2022-04-17 12:34:52', 1, 1, 'procesando'),
